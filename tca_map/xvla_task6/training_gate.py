"""Sequential MPR-XVLA bounded training plus offline validation gate."""
...
from tca_map.xvla_task6.offline_validate import DEFAULT_OUTPUT, OfflineValidationConfig, run_offline_validation
...
from tca_map.xvla_task6.training_spec import SPEC_ARTIFACT
...
def run_training_gate(config: TrainingGateConfig) -> dict[str, Any]:
    ...
    result: dict[str, Any] = {
        "schema_version": "2026-07-17.epoch5_MPR_XVLA_training_gate.v1",
        "method": "MPR-XVLA",
        "status": "RUNNING",
        "success": False,
        "decision": "MPR_XVLA_TRAINING_GATE_RUNNING",
        ...
        result.update(
            {
                "status": "FAILED",
                "success": False,
                "decision": "MPR_XVLA_TRAINING_GATE_FAILED",
