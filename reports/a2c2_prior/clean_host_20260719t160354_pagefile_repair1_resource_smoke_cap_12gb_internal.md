...
```json
{
  "after_resources": {
    ...
    "system_ram_used_fraction": 0.295,
    "system_ram_used_gib": 3.451,
  ...
  "before_resources": {
    ...
    "system_ram_limit_fraction": 0.82,
    "system_ram_total_gib": 11.68,
    "system_ram_used_fraction": 0.07,
    "system_ram_used_gib": 0.819,
  ...
  "peak_resources": {
    ...
    "peak_rss_mb": 4237.148,
    "peak_vram_allocated_mib": 900.057,
    "peak_vram_reserved_mib": 932.0,
    "peak_wsl_used_fraction": 0.329,
    "peak_wsl_used_gib": 3.846,
    "samples": 122
  },
  "prior_retrained": false,
  "purpose": "RESOURCE_ONLY_ACTUAL_PATH_SMOKE",
  "resource_cap_gib_requested": 12,
  ...
  "trace_evidence_without_outcome": {
    ...
    "reward_persisted": false,
    "rss_mb_at_trace_return": 4094.477,
    "simulator_step_count": 76,
    "task_success_persisted": false
  },
  "wslconfig_sha256": "A7CC4F707936DBBCE335F298BF0E968804F956E4DBE71A17ECEF5775CC708445"
}
```
