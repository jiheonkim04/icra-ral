...
```json
{
  "after_resources": {
    ...
    "system_ram_total_gib": 7.754,
    "system_ram_used_fraction": 0.436,
    "system_ram_used_gib": 3.384,
  ...
  "before_resources": {
    ...
    "system_ram_limit_fraction": 0.82,
    "system_ram_total_gib": 7.754,
    "system_ram_used_fraction": 0.103,
    "system_ram_used_gib": 0.795,
  ...
  "peak_resources": {
    ...
    "peak_rss_mb": 4175.73,
    "peak_vram_allocated_mib": 895.309,
    "peak_vram_reserved_mib": 932.0,
    "peak_wsl_used_fraction": 0.488,
    "peak_wsl_used_gib": 3.782,
    "samples": 128
  },
  "prior_retrained": false,
  "purpose": "RESOURCE_ONLY_ACTUAL_PATH_SMOKE",
  "resource_cap_gib_requested": 8,
  ...
  "trace_evidence_without_outcome": {
    ...
    "reward_persisted": false,
    "rss_mb_at_trace_return": 4031.844,
    "simulator_step_count": 76,
    "task_success_persisted": false
  },
  "wslconfig_sha256": "B64DE8C5F059556A6BE5867196AD000BE6F116CC21A0413ADD7CBF06654202EB"
}
```
