...
45. Current gate: benchmark/paper-grade rollout planning. Stop before benchmark rollout, multi-seed rollout, OpenVLA-OFT, full training, external upload, or paper-level claims unless a separate risk assessment and policy explicitly allow that exact step.
...
11. Stop before benchmark rollout, multi-seed rollout, OpenVLA-OFT, full training, external upload, or paper-level claims.
