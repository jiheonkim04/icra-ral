...
40. Current gate: separate bounded simulator render-smoke branch. Do not reset, step, rollout, or claim benchmark readiness unless the specific later risk assessment is green and inside budget.
...
6. Create and run a separate bounded render-smoke branch only if the render-smoke assessment is green.
