...
31. Current gate: HDF5 reader dependency check with `scripts\50_check_libero_hdf5_reader.ps1`. If `h5py` is unavailable, run a separate dependency risk assessment before installing it.
