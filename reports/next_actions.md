...
43. Tiny diagnostic rollout risk assessment. Done: `scripts\62_plan_tiny_diagnostic_rollout.ps1` reports a bounded planning envelope, with rollout execution still false.
44. Current gate: rollout execution. Stop here while the current user instruction forbids rollout execution.
...
9. Run a separate bounded tiny diagnostic rollout risk assessment only. Done.
10. Stop before rollout execution while the current user instruction forbids rollout.
