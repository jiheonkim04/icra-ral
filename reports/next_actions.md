...
33. Current gate: tiny counterfactual split construction from acquired LIBERO metadata/HDF5 inventory.
34. After counterfactual split readiness: tiny real/offline ActionMap vs TCA-Map comparison, required tiny LoRA comparison, and bounded local pilot report if each gate passes.
