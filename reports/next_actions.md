...
42. Current gate: bounded reset/step smoke. Create a separate task-local gated branch and risk assessment before any simulator reset or step. Rollout remains blocked.
...
8. Next: run a separate bounded reset/step-smoke risk assessment.
