...
12. Run `scripts\66_plan_libero_policy_rollout_readiness.ps1` before any learned-policy rollout. Current local state is green after WSL SmolVLA runtime setup/readiness.
