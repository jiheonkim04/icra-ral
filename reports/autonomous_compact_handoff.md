...
Repeated-residual screen `20260729..33`: goal/task3 `20260729` Base-solved; object/spatial `20260728` saturated; goal `20260729` no shared residual; object `20260729` saturated; spatial/task4 `20260729` second-prior-solved; goal `20260730` no shared residual; object `20260730` saturated; spatial/task5 shared failures (`20260727`,`20260730`,`20260733`) with headroom; `20260731/32` X-VLA-solved. Candidate cap exhausted: SGL simple-control-equivalent; OCR trigger unobservable (`59 passed`). Post-task5 goal/object `20260731` X-VLA saturated 10/10. Next: residual search elsewhere; no simulator/training/Ours.
