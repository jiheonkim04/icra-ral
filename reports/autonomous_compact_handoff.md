...
Repeated-residual screen `20260729..33`: `libero_goal/task3` at `20260729` was Base-solved; `libero_object`/`libero_spatial` identity `20260728` saturated; `libero_goal` identity `20260729` no shared residual; `libero_object` identity `20260729` saturated; `libero_spatial/task4` identity `20260729` was second-prior-solved; `libero_goal` identity `20260730` no shared residual; `libero_object` identity `20260730` saturated; `libero_spatial/task5` now has three clean Base/X-VLA/OpenVLA-INT4 failure identities (`20260727`,`20260730`,`20260733`) with task-level headroom, while `20260731/32` were X-VLA-solved. Candidate generation is authorized for at most two new candidates; R2P-XVLA remains archived; no training/Ours rollout.
