...
Repeated-residual screen `20260729..33`: `libero_goal/task3` at `20260729` was Base-solved; object/spatial `20260728` saturated; goal `20260729` no shared residual; object `20260729` saturated; spatial/task4 `20260729` second-prior-solved; goal `20260730` no shared residual; object `20260730` saturated; spatial/task5 has three clean Base/X-VLA/OpenVLA-INT4 failure identities (`20260727`,`20260730`,`20260733`) with task-level headroom, while `20260731/32` were X-VLA-solved. Candidate-generation report produced exactly two new specs: primary `SGL-XVLA`, backup `OCR-XVLA`; R2P-XVLA remains archived. Next: freeze no-training Stage 0 gate for `SGL-XVLA`; no training/Ours rollout.
