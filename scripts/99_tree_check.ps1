...
$required = @(
    ...
    "reports/css_shield_task_definition.md",
    "reports/css_shield_related_work_matrix.md",
    "reports/css_shield_novelty_matrix.md",
    ...
    "reports/css_shield_ral_strength_check.md",
    "reports/css_shield_ral_strength_check.json",
    "reports/css_shield_state4_scale_summary.md",
    "reports/css_shield_state4_scale_summary.json",
    "reports/css_shield_first_results.md",
    "reports/css_shield_main_table.md",
    "reports/css_shield_ablation_table.md",
    ...
    "reports/execspec_task_definition.md",
    "reports/execspec_related_work_matrix.md",
    "reports/execspec_experiment_plan.md",
    "reports/execspec_kill_criteria.md",
    "reports/execspec_state2_calibrated_repair.md",
    "reports/execspec_state2_calibrated_repair.json",
    "reports/execspec_state3_replay_validation.md",
    "reports/execspec_state3_replay_validation.json",
    "reports/execspec_state3_5_baseline_dominance_audit.md",
    "reports/execspec_state3_5_baseline_dominance_audit.json",
    ...
    "reports/amp_gd_state2_result.md",
    ...
    "scripts/169_amp_gd_state2_libero_port.ps1",
    ...
    "tca_map/execspec/__init__.py",
    "tca_map/execspec/mismatch_diagnostic.py",
    "tca_map/execspec/exact_init_mismatch_replay.py",
    ...
    "tca_map/amp_gd/state2_libero_port.py",
    ...
    "tests/test_amp_gd_state2_libero_port.py",
