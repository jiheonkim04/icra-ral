...
def test_active_campaign_final_decision_is_nonterminal_pivot() -> None:
    ...
    assert "TSC_PREREGISTRATION_FROZEN_PROTOTYPE_PROTOCOL_PENDING" in final
    ...
    assert "epoch_4_cycle_28_tsc_prototype_protocol_pending" in final
...
def test_active_campaign_state_records_governance_v2() -> None:
    ...
    assert (
        state["next_action"]
        == "Write executable TSC-VLA prototype protocol before Stage 0 implementation."
    )
