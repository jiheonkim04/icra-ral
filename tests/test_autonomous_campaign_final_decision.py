...
def test_active_campaign_final_decision_is_nonterminal_pivot() -> None:
    ...
    assert "TSC_PROTOTYPE_PROTOCOL_FROZEN_STAGE_0_PENDING" in final
    ...
    assert "epoch_4_cycle_28_tsc_stage_0_implementation_pending" in final
...
def test_active_campaign_state_records_governance_v2() -> None:
    ...
    assert (
        state["next_action"]
        == "Implement and validate scripts/run_tsc_vla_stage0.py before Stage 0 execution."
    )
