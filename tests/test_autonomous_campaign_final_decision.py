...
def test_active_campaign_final_decision_is_nonterminal_pivot() -> None:
    ...
    assert "Current stage: `epoch_4_cycle_12_cala_reviewer_attack_completed`" in final
...
def test_active_campaign_state_records_governance_v2() -> None:
    ...
    assert state["next_action"].startswith("Write the CALA-VLA Researcher A rebuttal")
