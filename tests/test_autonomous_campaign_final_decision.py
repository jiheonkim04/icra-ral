...
def test_active_campaign_final_decision_is_nonterminal_pivot() -> None:
    ...
    assert "reports/mci_vla/preregistration.md" in final
    ...
    assert "reports/epoch_4_cycle_38_candidate_generation.md" in final
    assert "rovla_multiconsistency_proxy" in final
    assert "mci_no_consistency_code_ablation" in final
    assert "augmentation_only_lora_killer" in final
    ...
    assert "reports/dccg_vla/stage_0_adjudication.md" in final
    assert "CSPR-VLA" in final
    assert CSPR_PROPOSAL_HASH in final
    ...
    assert "reports/epoch_4_cycle_37_candidate_generation.md" in final
    assert "reports/epoch_4_cycle_36_candidate_generation.md" in final
    assert "reports/dccg_vla/researcher_proposal.md" in final
    assert DCCG_PROPOSAL_HASH in final
    assert "acg_official_proxy" in final
...
def test_active_campaign_state_records_governance_v2() -> None:
    ...
    assert proto35["required_tests"] == "tests/test_mhs_vla.py"
