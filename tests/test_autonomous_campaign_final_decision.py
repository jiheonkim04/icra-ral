...
def test_active_campaign_final_decision_is_nonterminal_pivot() -> None:
    ...
    assert "Current campaign decision: `RAR_PROPOSAL_FROZEN_REVIEWER_ATTACK_PENDING`" in final
    ...
    assert "Current stage: `epoch_4_cycle_13_rar_proposal_frozen`" in final
...
def test_active_campaign_state_records_governance_v2() -> None:
    ...
    assert state["next_action"].startswith("Run Reviewer B attack on the frozen RAR-VLA proposal")
