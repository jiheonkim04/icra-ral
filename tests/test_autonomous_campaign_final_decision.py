...
def test_active_campaign_final_decision_is_nonterminal_pivot() -> None:
    ...
    assert "Current campaign decision: `MTF_STAGE_A_NONCATASTROPHIC_TO_STAGE_B_REQUIRED`" in final
...
def test_active_campaign_state_records_governance_v2() -> None:
    ...
    assert state["next_action"].startswith("Freeze and run the MTF-VLA Stage B official WSL rollout")
