...
def test_active_campaign_final_decision_is_nonterminal_pivot() -> None:
    ...
    assert "Current campaign decision: `G3P_STAGE_0_STOP_DATA_OR_SUPERVISION_FAILURE`" in final
    ...
    assert "Current stage: `epoch_4_cycle_11_g3p_stage_0_completed`" in final
...
def test_active_campaign_state_records_governance_v2() -> None:
    ...
    assert state["next_action"].startswith("Start Epoch 4 Cycle 12 candidate generation")
